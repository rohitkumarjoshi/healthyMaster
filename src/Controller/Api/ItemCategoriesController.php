	...
	public function home()
    {
		...
		foreach($HomeScreens as $HomeScreen){
			...
			if($HomeScreen->layout=='SingleImage'){
				...
				$Items = array("title"=>$HomeScreen->title,'layout'=>$HomeScreen->layout,'category_id'=>$HomeScreen->category_id,'item_id'=>$HomeScreen->item_id,'image'=>$HomeScreen->image,'image_fullpath'=>'https://healthymaster.in/healthymaster/img/home_screen/'.$HomeScreen->image,"DynamicList"=>$items);
