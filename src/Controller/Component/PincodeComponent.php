...
class PincodeComponent extends Component
{
	...
	public function getWithoutPinodeCharge($cus_city_id = null,$cus_state_id = null,$customer_id = null)
    { 
	...
	public function getDeliveryChargeOrderWithoutPincode($cus_city_id = null,$cus_state_id=null,$order_id = null)
    { 
