            ...
            <div class="portlet-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php echo $this->Form->control('pincode',['placeholder'=>'Pincode','class'=>'form-control input-sm','label'=>false,'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');",'type'=>'text','required','id'=>'pincode','maxlength'=>6]); ?>
