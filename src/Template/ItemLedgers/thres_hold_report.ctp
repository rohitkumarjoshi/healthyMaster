		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-purple-intense ">THRESHOLD REPORT
					</span>
				</div>
				<div class="actions"> 
				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php $i=1; foreach($Items as $Item){ 
								...
								if(@$QuantityTotalStock[$Item->id] <= 5000) { 
								//$tempcolspan=(sizeof($Item->item_variations))
								?>
								
									<tr class="main_tr" class="tab">
										<td  style="text-align:center" width="1px"><?= $i++ ?>.</td>
										<td style="text-align:center"><?= $Item->item_category->name ?></td>
										<td style="text-align:center"><?= $Item->name ?></td>
										<td style="text-align:center">
										<?php
											if(empty($QuantityTotalStock[$Item->id])){
												echo "0";
											}else{
											echo @$QuantityTotalStock[$Item->id];
											}
											?>
										</td>
