		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-purple-intense ">VARIATION STOCK REPORT
					</span>
				</div>
				<div class="actions"> 
			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php $i=0; foreach($ItemData as $Item){ //pr($Item); exit;
								...
								?>
									<tr class="main_tr" class="tab">
										...
										<td style="text-align:center"><?= $Item->item->name.' ('.$Item->quantity_variation.''. $Item->unit->shortname.')'?></td>
